...
echo "Updating codepipeline $awsdevopsdemo_codepipeline."
...
if [ "$pipeline_file" == "codepipeline/pipeline-ghsource-buildandtest-beta-ghostinspector-prod.json" ]; then
...
echo "Updated codepipeline $awsdevopsdemo_codepipeline."
